...
<fieldset class="peek black" id="{$div_id}">
	<div class="oauth-button" style="padding:10px;background-color:rgb(213,46,31);color:white;display:inline-block;cursor:pointer;">
		{if $params.access_token}
		<b style="color:white;text-decoration:none;">Linked to {$params.label|default:'a Google account'}</b>
		{else}
		<b style="color:white;text-decoration:none;">Link to a Google account</b>
		{/if}
	</div>
